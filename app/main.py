...
from legal_portal.core.auth import AuthManager, Permissions, UserRole
from legal_portal.core.helpers import handle_file_uploads

# Enhanced observability imports
from legal_portal.core.logging_config import (
    MetricsCollector,
    app_logger,
    audit_logger,
    auth_logger,
...
from legal_portal.core.session_manager import SessionManager, SessionMonitor
from legal_portal.core.structured_logger import request_id_var, session_id_var, user_id_var
from legal_portal.core.tracing import Span, trace
