...
def test_upload_unsupported_file():
    ...
    """
    with open("samples/Badam, Balaji [MetLife]/Client Docs/imessage - Breanna communication 1.jpg", "rb") as f:
        response = client.post(
            "/api/legal-analysis-upload",
            files={"files": ("imessage - Breanna communication 1.jpg", f, "image/jpeg")}
        )
