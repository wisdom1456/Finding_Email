...
def large_video_insight():
    ...
    large_insights = {
        "summary": "Comprehensive video analysis showing extensive property damage and construction defects. " * 100,
        "timeline": [f"Time {i}: Detailed event description with extensive analysis" for i in range(200)],
        "objects": [f"object_{i}_with_detailed_description_and_extensive_metadata" for i in range(150)],
        "content_analysis": {
            "scene_analysis": ["Detailed scene " + "analysis " * 50 for _ in range(100)],
            "object_tracking": ["Object tracking data " + "detailed " * 30 for _ in range(80)],
            "motion_analysis": ["Motion analysis " + "comprehensive " * 40 for _ in range(60)]
        },
        "quality_metrics": {
            "resolution": "4K",
            "framerate": "60fps", 
    ...
    return VideoInsight(
        ...
        transcript="This is a very long transcript with extensive dialogue and detailed descriptions. " * 200,
...
class TestVideoPreservationStrategy:
    ...
    def test_small_video_data_structure_validation(self, sample_intake_analysis, small_video_insight):
        """
    ...
    def test_large_video_summarization_trigger(self, sample_intake_analysis, large_video_insight):
        """
    ...
    def test_token_counting_logic_simulation(self, sample_intake_analysis, small_video_insight, large_video_insight):
        """
    ...
    def test_video_preservation_metadata_structure(self, large_video_insight):
        ...
        video.insights_gcs_uri = "gs://findings-video-analysis/test-uuid-123/full_insights.json"
    ...
    def test_email_appendix_truncation_notice_structure(self, sample_intake_analysis, large_video_insight):
        """
        ...
        video = analysis.video_insights[0]
        video.insights_gcs_uri = "gs://findings-video-analysis/test-uuid/full_insights.json"
    ...
    def test_mixed_video_sizes_processing(self, sample_intake_analysis, small_video_insight, large_video_insight):
        """
        ...
        small_content_size = len(str(small_video.insights)) + len(small_video.transcript)
        assert small_content_size < 10000  # Small enough to process normally
        
        # Large video should trigger preservation
        large_content_size = len(str(large_video.insights)) + len(large_video.transcript)
