from backend.tests.utils.rtf_processor import rtf_to_text, normalize_text, extract_structured_content
...
class EmailComparator:
    ...
    def compare(self):
        ...
        self.compare_structure(ref_email["structured_content"], gen_email["structured_content"])
        self.compare_substance(ref_email["normalized_text"], gen_email["normalized_text"])
