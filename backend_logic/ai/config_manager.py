...
class ConfigManager:
    ...
    def __init__(self, config_path: str | None = None):
        ...
        print(f"CONFIG MANAGER: ✅ Initialized with configuration: {config_path or 'default'}")
    ...
    def _load_configuration(self, config_path: str | None = None) -> dict[str, Any]:
        ...
        if not os.path.exists(config_path):
            print(f"CONFIG MANAGER: ⚠️  Configuration file not found: {config_path}, using default prompts")
            return {}
        ...
        try:
            ...
            print(f"CONFIG MANAGER: ⚠️  Failed to parse YAML configuration: {e}, using default prompts")
            return {}
        except Exception as e:
            print(f"CONFIG MANAGER: ⚠️  Failed to load configuration: {e}, using default prompts")
            return {}
