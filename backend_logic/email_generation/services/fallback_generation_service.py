...
class FallbackGenerationService:
    ...
    def create_fallback_letter(
        self, case_data: Dict[str, Any] = None, error_context: str = None
    ) -> str:
        """
    ...
    def generate_fallback_factual_summary(
        self, case_data: Dict[str, Any] = None
    ) -> str:
        """
    ...
    def generate_fallback_evidence_review(
        self, case_data: Dict[str, Any] = None
    ) -> str:
        """
...
Comprehensive compliance recommendations will follow.
    ...
    def _generate_template_fallback(
        ...
        if error_context:
            sections.append(
                f"Note: Generated using fallback content due to: {error_context}"
            )
            sections.append("")
