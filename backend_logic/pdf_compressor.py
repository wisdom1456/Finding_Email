...
class PDFCompressor:
    ...
    def __init__(self, size_threshold_mb: int = 10) -> None:
    ...
    async def compress_pdf_if_needed(self, document: SavedDocument) -> SavedDocument:
        ...
        try:
            ...
            if file_size > self.size_threshold_bytes:
                ...
                print(
                    f"Compression complete. Original size: {file_size} bytes, New size: {new_file_size} bytes."
                )
    ...
    async def _compress_pdf(self, input_path: str, output_path: str) -> None:
        """
