...
class ConfigManager:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        logger.info(
            f"CONFIG MANAGER: ✅ Initialized with configuration: {config_path or 'default'}"
        )
    ...
    def _load_configuration(self, config_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                f"CONFIG MANAGER: ⚠️  Failed to parse YAML configuration: {e}, using default prompts"
            )
            return {}
        except Exception as e:
            logger.error(
                f"CONFIG MANAGER: ⚠️  Failed to load configuration: {e}, using default prompts"
            )
            return {}
