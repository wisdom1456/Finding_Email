		...
		<form onsubmit={(e) => { e.preventDefault(); saveProfile(); }}>
			...
			<div class="flex justify-end">
				<button
					type="submit"
					disabled={saving}
					class="px-6 py-2.5 text-sm font-medium rounded-md text-white bg-accent hover:bg-accent-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
				>
					{#if saving}
