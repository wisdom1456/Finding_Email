...
from legal_portal.services.documents.extraction_service import (
    _MIME_TO_FILETYPE,
...
# ============================================================================
# These symbols are imported by tests and other modules. Keep them accessible
# from this module to avoid breaking existing imports.
__all__ = [
    # Service-layer functions re-exported for backward compatibility
    "_MIME_TO_FILETYPE",
    "_build_and_persist_registry",
    "_detect_image_mime",
    "_ensure_vision_compatible",
