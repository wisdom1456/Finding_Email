...
class OpenAIIntegrationService:
    ...
    def build_enhanced_prompt(
        ...
        if section_type in section_instructions:
            enhanced_parts.append(f"SECTION FOCUS: {section_instructions[section_type]}")
    ...
    def generate_factual_summary(self, case_data: Dict[str, Any]) -> str:
        ...
        enhanced_prompt = self.build_enhanced_prompt(base_prompt, case_data, "factual_summary")
    ...
    def generate_legal_analysis(self, case_data: Dict[str, Any]) -> str:
        ...
        enhanced_prompt = self.build_enhanced_prompt(base_prompt, case_data, "legal_analysis")
    ...
    def generate_evidence_review(self, case_data: Dict[str, Any]) -> str:
        ...
        enhanced_prompt = self.build_enhanced_prompt(base_prompt, case_data, "evidence_review")
    ...
    def generate_recommendations(self, case_data: Dict[str, Any]) -> str:
        ...
        enhanced_prompt = self.build_enhanced_prompt(base_prompt, case_data, "recommendations")
