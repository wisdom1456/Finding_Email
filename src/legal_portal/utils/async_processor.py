...
if TYPE_CHECKING:
    from legal_portal.services.services.document_processor import DocumentProcessor
    from legal_portal.services.services.task_manager import TaskManager
...
async def process_documents_async(
    ...
    try:
        ...
        intake_docs_saved = [doc for doc in saved_documents if doc.original_filename == intake_filename]
        if not intake_docs_saved:
            raise ValueError("Intake form is required but was not found.")
