...
class CostEstimator:
    ...
    def estimate_document_processing_costs(self, documents: List[ProcessedDocument]) -> List[ServiceCost]:
    ...
    def estimate_audio_processing_costs(self, audio_files: List[Dict[str, Any]]) -> List[ServiceCost]:
        ...
        for audio_file in audio_files:
            ...
            whisper_cost = (
                Decimal(str(estimated_minutes)) * self.PRICING_RATES["openai_whisper"]["per_minute"]
            )
    ...
    def estimate_video_processing_costs(self, video_files: List[Dict[str, Any]]) -> List[ServiceCost]:
        ...
        for video_file in video_files:
            ...
            video_costs.append(
                ServiceCost(
                    ...
                    unit_type="tokens",
                    rate_per_unit=float(self.PRICING_RATES["vertex_ai_gemini_flash"]["input_tokens"]),
