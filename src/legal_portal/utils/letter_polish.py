...
8. Remove distancing or doubt-casting phrasing toward the client, EXCEPT in the Background & Issue section where "You report that..." is appropriate attribution language and must be preserved. In other sections, replace phrases like "you state", "you say", "you claim", "you allege", or "you indicate" with direct, trust-affirming language: "you have", "you invested", "as you described", "based on what you've shared."
