...
def test_criminal_video_analysis():
    ...
    evidence_item = CriminalEvidenceItem(
        ...
        key_observations=["Clear delivery of rights", "Suspect acknowledges understanding"],
...
def test_enhanced_video_insight():
    ...
    evidence_item = CriminalEvidenceItem(
        ...
        key_observations=["Proper handcuff placement", "Officer explains arrest reason"],
...
def test_case_analysis_result_integration():
    ...
    evidence_item = CriminalEvidenceItem(
        ...
        key_observations=["Proper 20-minute observation period", "Calibrated equipment used"],
    ...
    case_result = CaseAnalysisResult(
        video_insights=[regular_insight, enhanced_insight]
    )
