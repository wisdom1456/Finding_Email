...
def test_video_relevance_analysis():
    ...
    relevance_analysis = email_generator.analyze_video_relevance(
        video_insight, case_analysis.intake_analysis
    )
...
def test_email_template_integration():
    ...
    try:
        timeline = email_generator.generate_case_timeline(case_analysis)
        video_insight = case_analysis.video_insights[0]
        video_relevance = email_generator.analyze_video_relevance(
            video_insight, case_analysis.intake_analysis
        )
        video_formatting = email_generator.format_video_analysis_for_appendix(
            video_insight
        )
...
def test_template_structure():
    ...
    try:
        ...
        with open("backend/assets/templates/findings_email.jinja2") as f:
