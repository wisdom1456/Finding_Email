...
def find_sample_videos():
    ...
    video_dir = project_root / "samples" / "Price, Clifton [MetLife]" / "Shared Folder with Client" / "Shared with Bernhardt Riley" / "2024 Pictures Videos"
...
async def main():
    ...
    if success:
        ...
        print("✅ The video processing pipeline is correctly configured and functional.")
