...
def create_test_data():
    ...
    test_timeline = [
        {"date": "2024-03-15", "event": "Initial incident occurred", "source": "Police_Report.pdf"},
        {"date": "2024-03-16", "event": "Client sought medical attention", "source": "Medical_Records.pdf"},
    ]
