...
from backend.utils.data_models import (
    # Enums
    FileType, DocumentType, CaseType, UrgencyLevel, EvidenceStrength,
    
    # Core models
    FileMetadata, ProcessedDocument, AnalysisError,
    
    # Analysis models
    EnhancedIntakeAnalysis, AnalyzedDocument, ChallengeAssessment,
    LegalAssessment, DemandLetterEvaluation, CaseAnalysisResult,
...
class TestEmailModels:
    ...
    def test_download_link_creation(self):
        ...
        link = DownloadLink(
            file_name="findings.eml",
            url="data:message/rfc822;base64,..."
        )
